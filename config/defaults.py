...
_C.MODEL.PROMPTSG.LAMBDA_SUPCON = 0.5
_C.MODEL.PROMPTSG.PROMPT_MODE = 'composed'
_C.MODEL.PROMPTSG.TEMPERATURE = 1.0
_C.MODEL.PROMPTSG.CROSS_ATTN_HEADS = 8
_C.MODEL.PROMPTSG.POST_CA_BLOCKS = 2
...
_C.SOLVER.PROMPTSG = CN()
_C.SOLVER.PROMPTSG.IMS_PER_BATCH = 64
_C.SOLVER.PROMPTSG.OPTIMIZER_NAME = "Adam"
_C.SOLVER.PROMPTSG.MAX_EPOCHS = 60
_C.SOLVER.PROMPTSG.BASE_LR_VISUAL = 5e-6
_C.SOLVER.PROMPTSG.BASE_LR_NEW = 5e-5
_C.SOLVER.PROMPTSG.WEIGHT_DECAY = 1e-4
_C.SOLVER.PROMPTSG.GAMMA = 0.1
_C.SOLVER.PROMPTSG.STEPS = (20, 40)
_C.SOLVER.PROMPTSG.CHECKPOINT_PERIOD = 60
_C.SOLVER.PROMPTSG.LOG_PERIOD = 50
_C.SOLVER.PROMPTSG.EVAL_PERIOD = 60
_C.SOLVER.PROMPTSG.WARMUP_EPOCHS = 0
_C.SOLVER.PROMPTSG.WARMUP_LR_INIT = 0.0
